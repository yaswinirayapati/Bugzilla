...
PROJECT_KEY = os.getenv("PROJECT_KEY", "BUG")
LOG_FILE_PATH = os.getenv("LOG_FILE_PATH")
OPENROUTER_API_KEY = os.getenv("OPENROUTER_API_KEY", "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")
...
def create_detailed_jira_ticket(error_message, error_type, severity, assigned_team, ai_analysis):
    """Create comprehensive JIRA ticket with all details"""
    if not jira:
...
*This ticket was automatically generated by the Bug Tester AI system.*
        ...
        print(f"🔧 Creating JIRA ticket for {error_type} - Team: {assigned_team}")
